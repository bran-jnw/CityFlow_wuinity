...
public class StringDoubleMap : global::System.IDisposable 
    , global::System.Collections.Generic.IDictionary<string, double>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          CityFlowPINVOKE.delete_StringDoubleMap(swigCPtr);
        }
  ...
  public StringDoubleMap() : this(CityFlowPINVOKE.new_StringDoubleMap__SWIG_0(), true) {
  }

  public StringDoubleMap(StringDoubleMap other) : this(CityFlowPINVOKE.new_StringDoubleMap__SWIG_1(StringDoubleMap.getCPtr(other)), true) {
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = CityFlowPINVOKE.StringDoubleMap_size(swigCPtr);
    return ret;
  }

  private bool empty() {
    bool ret = CityFlowPINVOKE.StringDoubleMap_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    CityFlowPINVOKE.StringDoubleMap_Clear(swigCPtr);
  }

  private double getitem(string key) {
    double ret = CityFlowPINVOKE.StringDoubleMap_getitem(swigCPtr, key);
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(string key, double x) {
    CityFlowPINVOKE.StringDoubleMap_setitem(swigCPtr, key, x);
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool ContainsKey(string key) {
    bool ret = CityFlowPINVOKE.StringDoubleMap_ContainsKey(swigCPtr, key);
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(string key, double value) {
    CityFlowPINVOKE.StringDoubleMap_Add(swigCPtr, key, value);
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(string key) {
    bool ret = CityFlowPINVOKE.StringDoubleMap_Remove(swigCPtr, key);
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private global::System.IntPtr create_iterator_begin() {
    global::System.IntPtr ret = CityFlowPINVOKE.StringDoubleMap_create_iterator_begin(swigCPtr);
    return ret;
  }

  private string get_next_key(global::System.IntPtr swigiterator) {
    string ret = CityFlowPINVOKE.StringDoubleMap_get_next_key(swigCPtr, swigiterator);
    return ret;
  }

  private void destroy_iterator(global::System.IntPtr swigiterator) {
    CityFlowPINVOKE.StringDoubleMap_destroy_iterator(swigCPtr, swigiterator);
  }
