...
public class StringIntMap : global::System.IDisposable 
    , global::System.Collections.Generic.IDictionary<string, int>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          CityFlowPINVOKE.delete_StringIntMap(swigCPtr);
        }
  ...
  public StringIntMap() : this(CityFlowPINVOKE.new_StringIntMap__SWIG_0(), true) {
  }

  public StringIntMap(StringIntMap other) : this(CityFlowPINVOKE.new_StringIntMap__SWIG_1(StringIntMap.getCPtr(other)), true) {
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = CityFlowPINVOKE.StringIntMap_size(swigCPtr);
    return ret;
  }

  private bool empty() {
    bool ret = CityFlowPINVOKE.StringIntMap_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    CityFlowPINVOKE.StringIntMap_Clear(swigCPtr);
  }

  private int getitem(string key) {
    int ret = CityFlowPINVOKE.StringIntMap_getitem(swigCPtr, key);
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(string key, int x) {
    CityFlowPINVOKE.StringIntMap_setitem(swigCPtr, key, x);
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool ContainsKey(string key) {
    bool ret = CityFlowPINVOKE.StringIntMap_ContainsKey(swigCPtr, key);
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(string key, int value) {
    CityFlowPINVOKE.StringIntMap_Add(swigCPtr, key, value);
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(string key) {
    bool ret = CityFlowPINVOKE.StringIntMap_Remove(swigCPtr, key);
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private global::System.IntPtr create_iterator_begin() {
    global::System.IntPtr ret = CityFlowPINVOKE.StringIntMap_create_iterator_begin(swigCPtr);
    return ret;
  }

  private string get_next_key(global::System.IntPtr swigiterator) {
    string ret = CityFlowPINVOKE.StringIntMap_get_next_key(swigCPtr, swigiterator);
    return ret;
  }

  private void destroy_iterator(global::System.IntPtr swigiterator) {
    CityFlowPINVOKE.StringIntMap_destroy_iterator(swigCPtr, swigiterator);
  }
