...
public class JsonFormatError : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          CityEnginePINVOKE.delete_JsonFormatError(swigCPtr);
        }
  ...
  public JsonFormatError(SWIGTYPE_p_std__string info) : this(CityEnginePINVOKE.new_JsonFormatError(SWIGTYPE_p_std__string.getCPtr(info)), true) {
