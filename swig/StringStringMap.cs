...
public class StringStringMap : global::System.IDisposable 
    , global::System.Collections.Generic.IDictionary<string, string>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          CityFlowPINVOKE.delete_StringStringMap(swigCPtr);
        }
  ...
  public StringStringMap() : this(CityFlowPINVOKE.new_StringStringMap__SWIG_0(), true) {
  }

  public StringStringMap(StringStringMap other) : this(CityFlowPINVOKE.new_StringStringMap__SWIG_1(StringStringMap.getCPtr(other)), true) {
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = CityFlowPINVOKE.StringStringMap_size(swigCPtr);
    return ret;
  }

  private bool empty() {
    bool ret = CityFlowPINVOKE.StringStringMap_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    CityFlowPINVOKE.StringStringMap_Clear(swigCPtr);
  }

  private string getitem(string key) {
    string ret = CityFlowPINVOKE.StringStringMap_getitem(swigCPtr, key);
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(string key, string x) {
    CityFlowPINVOKE.StringStringMap_setitem(swigCPtr, key, x);
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool ContainsKey(string key) {
    bool ret = CityFlowPINVOKE.StringStringMap_ContainsKey(swigCPtr, key);
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(string key, string value) {
    CityFlowPINVOKE.StringStringMap_Add(swigCPtr, key, value);
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(string key) {
    bool ret = CityFlowPINVOKE.StringStringMap_Remove(swigCPtr, key);
    if (CityFlowPINVOKE.SWIGPendingException.Pending) throw CityFlowPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private global::System.IntPtr create_iterator_begin() {
    global::System.IntPtr ret = CityFlowPINVOKE.StringStringMap_create_iterator_begin(swigCPtr);
    return ret;
  }

  private string get_next_key(global::System.IntPtr swigiterator) {
    string ret = CityFlowPINVOKE.StringStringMap_get_next_key(swigCPtr, swigiterator);
    return ret;
  }

  private void destroy_iterator(global::System.IntPtr swigiterator) {
    CityFlowPINVOKE.StringStringMap_destroy_iterator(swigCPtr, swigiterator);
  }
